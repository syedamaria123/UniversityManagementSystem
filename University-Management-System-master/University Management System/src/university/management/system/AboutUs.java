...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        ("university/management/system/icons/logo.jpg"));
            ...
            JLabel l9 = new JLabel("Education - Bachelor of Science (Software Engineering)");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel("Phone: +92 123 4567890");
